      ...
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <Badge className={cn("absolute -top-1 -right-1 size-5 p-0 flex items-center justify-center text-xs font-light bg-gradient-to-r border-0 text-white", scheme.from, scheme.to)}>
              3
            </Badge>
          </Button>
        </div>
