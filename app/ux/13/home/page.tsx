...
export default function UX13DashboardPage() {
  const { scheme } = useColorScheme()

  return (
    <>
      {/* Hero Section - Data Exploration */}
      <div className={cn("rounded-3xl p-12 mb-8 border bg-gradient-to-br", scheme.bg, scheme.bgHover, scheme.from.replace("from-", "border-").replace("500", "100"))}>
