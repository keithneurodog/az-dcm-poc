...
export default function UX5DashboardPage() {
  return (
    <UX5Layout>
      {/* Hero Section */}
      <div className="mb-8 -mx-8 -mt-8 bg-gradient-to-br from-[#0F4C81] via-[#0D9488] to-[#0891B2] px-8 py-12 text-white">
        <div className="max-w-4xl">
          <Badge className="mb-4 bg-[#F59E0B] text-white hover:bg-[#F59E0B]/90">
            Welcome back, John
          </Badge>
          ...
          <div className="flex gap-3">
            ...
            <Button size="lg" className="bg-[#F59E0B] hover:bg-[#F59E0B]/90 text-white font-semibold h-12">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <Card className="border-none shadow-lg bg-gradient-to-br from-[#0F4C81] to-[#1E40AF] text-white">
        ...
        <Card className="border-none shadow-lg bg-gradient-to-br from-[#0891B2] to-[#06B6D4] text-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-2">
        ...
        <Card className="border-none shadow-lg bg-gradient-to-br from-[#0D9488] to-[#14B8A6] text-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-2">
        ...
        <Card className="border-none shadow-lg bg-gradient-to-br from-[#1E40AF] to-[#2563EB] text-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-2">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <Card className="border-2 border-[#F59E0B] bg-gradient-to-br from-[#F59E0B]/5 to-[#F59E0B]/10">
            <CardHeader>
            ...
            <CardContent className="space-y-3">
              <Button className="w-full bg-[#0D9488] hover:bg-[#0D9488]/90 h-11">
              ...
              <div className="space-y-2">
                ...
                {["Find clinical trial data", "Request dataset access", "View usage analytics"].map((action) => (
                  <button
                    key={action}
                    className="w-full text-left text-sm px-3 py-2 rounded border border-neutral-200 hover:border-[#0D9488] hover:bg-[#0D9488]/5 transition-colors"
                  >
                    {action}
                  </button>
                ))}
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start justify-between border-l-4 border-[#0D9488] pl-3 py-2 bg-neutral-50 rounded-r">
              ...
              <Button variant="link" className="w-full mt-3 text-[#0D9488] p-0 h-auto">
              ...
              <tbody className="divide-y">
                {[
                  ...
                  <tr key={dataset.rank} className="hover:bg-neutral-50">
                    <td className="px-4 py-3">
                      <div className="flex size-8 items-center justify-center bg-[#F59E0B]/10 text-[#0D9488] font-bold text-sm rounded">
                        {dataset.rank}
                      </div>
                    </td>
