...
export default function UX5ManagementPage() {
  return (
    <UX5Layout>
      {/* Header */}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Badge variant="secondary" className="bg-[#F59E0B]/10 text-[#0D9488] border border-[#F59E0B]">
                    8 Pending
                  </Badge>
                </div>
              </div>
                      ...
                      <tr key={i} className="hover:bg-neutral-50">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            <div className="flex size-10 items-center justify-center bg-[#F59E0B]/10 text-[#0D9488] font-semibold text-sm rounded">
                              {user.name
                                .split(" ")
                                .map((n) => n[0])
                                .join("")}
