...
export default function UX8ManagementPage() {
  return (
    <UX8Layout>
      {/* Header */}
      <div className="mb-12 flex items-center justify-between">
        ...
        <Button className="bg-gradient-to-r from-rose-500 to-orange-400 hover:from-rose-600 hover:to-orange-500 text-white rounded-full font-light px-6">
      ...
      <Tabs defaultValue="datasets" className="space-y-8">
        <TabsList className="bg-white border border-neutral-200 rounded-full p-1">
          <TabsTrigger
            value="datasets"
            className="rounded-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-orange-400 data-[state=active]:text-white font-light"
          >
            Datasets
          </TabsTrigger>
          <TabsTrigger
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-neutral-50 hover:bg-white border border-transparent hover:border-neutral-200 transition-all">
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-rose-500 to-orange-400 text-white text-sm font-light">
                      {i + 1}
                    </div>
          ...
          <Card className="border-neutral-200 rounded-2xl overflow-hidden">
            <CardHeader className="border-b border-neutral-100 bg-white">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-gradient-to-r from-rose-500 to-orange-400 text-white border-0 rounded-full font-light">
                  8 Pending
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-3">
                {[
                  ...
                  return (
                    <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-neutral-50 hover:bg-white border border-transparent hover:border-neutral-200 transition-all">
                      <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-rose-500 to-orange-400 text-white text-xs font-light">
