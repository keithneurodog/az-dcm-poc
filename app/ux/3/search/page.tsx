import { UX3Layout } from "@/app/ux/_components/ux3-layout"
import {
  Card,
  CardContent,
  CardHeader,
...
export default function UX3SearchPage() {
  return (
    <UX3Layout>
      {/* Header */}
      <div className="mb-6">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            {["Clinical Trials", "2024", "Approved"].map((filter) => (
              <Badge
                key={filter}
                variant="secondary"
                className="bg-[#F0AB00]/10 text-[#830051] border border-[#F0AB00]"
              >
                {filter}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-start gap-2">
                        <button className="mt-0.5">
                          <Star
                            className={`size-4 ${dataset.starred ? "fill-[#F0AB00] text-[#F0AB00]" : "text-neutral-300"}`}
                          />
                        </button>
