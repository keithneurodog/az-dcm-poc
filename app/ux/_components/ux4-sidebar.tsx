...
const navigation = [
  { name: "Dashboard", href: "/ux/4/home", icon: LayoutDashboard },
  { name: "Search", href: "/ux/4/search", icon: Search },
  { name: "Management", href: "/ux/4/management", icon: FileStack },
  { name: "Settings", href: "#", icon: Settings },
]

export function UX4Sidebar() {
