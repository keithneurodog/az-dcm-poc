...
export default function DCMPropositionReviewPage() {
  ...
  const handleApprove = async () => {
    ...
    router.push("/collectoid-v2/dcm/propositions?approved=true")
  }
  ...
  const handleReject = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/dcm/propositions?rejected=true")
  }
  ...
  const handleRequestChanges = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/dcm/propositions?changes_requested=true")
  }
  ...
  const handleMerge = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/dcm/propositions?merged=true")
  }
