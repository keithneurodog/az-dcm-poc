...
export default function DCMPropositionReviewPage() {
  ...
  const handleApprove = async () => {
    ...
    router.push("/collectoid-v2/delivery-demo/dcm/propositions?approved=true")
  }
  ...
  const handleReject = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/delivery-demo/dcm/propositions?rejected=true")
  }
  ...
  const handleRequestChanges = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/delivery-demo/dcm/propositions?changes_requested=true")
  }
  ...
  const handleMerge = async () => {
    ...
    setIsSubmitting(true)
    await new Promise(resolve => setTimeout(resolve, 1500))
    router.push("/collectoid-v2/delivery-demo/dcm/propositions?merged=true")
  }
    ...
    <div className="py-8">
      ...
      <div className="mb-8">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => router.push("/collectoid-v2/delivery-demo/dcm/propositions")}
