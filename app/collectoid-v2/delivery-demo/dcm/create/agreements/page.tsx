...
export default function AgreementOfTermsPage() {
  ...
  const handleContinue = () => {
    if (aot) {
      ...
      router.push("/collectoid-v2/delivery-demo/dcm/create/review")
    }
  }

  const handleBack = () => {
    router.push("/collectoid-v2/delivery-demo/dcm/create/activities")
  }
                ...
                <div className="flex flex-col items-end gap-2 shrink-0">
                  ...
                  {conflictsExpanded && (
                    <div className="flex flex-col items-end gap-1.5">
                      <button
                        onClick={() => router.push("/collectoid-v2/delivery-demo/dcm/create/filters")}
