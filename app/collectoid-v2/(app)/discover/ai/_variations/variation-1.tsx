...
const MOCK_AI_RESPONSE = {
  ...
  statistics: {
    ...
    needsApproval: 21,
    missingLocation: 5,
    datasetsInCollections: 50,
    uncollectedDatasets: 3,
    userHasAccessCount: 23,
  },
}
...
export default function Variation1() {
  ...
  const handleSearch = async () => {
    ...
    setKeywords([...MOCK_AI_RESPONSE.keywords])
  ...
  const getIntentMatchBadge = (match: string) => {
    switch (match) {
      ...
      case "partial":
        return { label: "Partial match", color: "bg-amber-100 text-amber-700 border-amber-200" }
      case "none":
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            >
                              ML/AI {collection.intents.ml ? "yes" : "no"}
                            </Badge>
                            <Badge
                              variant="outline"
                              className={cn(
                            ...
                            >
                              Publish {collection.intents.publish ? "yes" : "no"}
                            </Badge>
                          </div>
                      ...
                      <div className="flex items-center justify-end gap-3 pt-4 border-t border-neutral-100">
                        ...
                        <Button
                          ...
                          onClick={(e) => {
                            ...
                            router.push(`/collectoid-v2/collections/${collection.id}/request`)
                          }}
                          className={cn(
